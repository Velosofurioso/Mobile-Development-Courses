...
import com.lvb.courses.app_guests.databinding.FragmentAllBinding
...
class AllGuestsFragment : Fragment(), GuestListener {
    ...
    override fun onResume() {
        super.onResume()
        mGuestsViewModel.load(GuestConstants.FILTER.EMPTY)
    }
